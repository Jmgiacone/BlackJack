...
{
    private int bet, insuranceBet, money;
     ...
     */
    public BlackJackPlayer(String n, int m)
    {
        super(n);
     ...
     */
    public BlackJackPlayer(BlackJackPlayer p)
    {
        super(p.getName());
        money = p.money;
        bet = p.bet;
        insurance = p.insurance;
        primaryHand = p.primaryHand;
    }
     ...
     */
    public void insurance(int aBet)
    {
        //Insurance pays 2:1
        insuranceBet = aBet;
        money -= insuranceBet;
